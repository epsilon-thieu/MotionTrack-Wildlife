...
def scale_coords(img1_shape, coords, img0_shape, ratio_pad=None):
    # [640, 1920]，torch.Size([8, 4])  [640, 1920]   [[1.0, 1.0], [32.0, 32.0]]
...
def scale_coords_upper_left(img1_shape, coords, img0_shape):
    # If the upper left corner is filled, you don't need to worry about the offset
    gain = min(img1_shape[0] / img0_shape[0], img1_shape[1] / img0_shape[1])  # gain  = old / new
    coords[:, :4] /= gain
    clip_coords(coords, img0_shape)
    return coords

    ...
    for epoch in range(start_epoch, epochs):
        ...
        if rank in [-1, 0]:
            ...
            if (not opt.nosave) or (final_epoch and not opt.evolve):  # if save
                ...
                # if (best_fitness == fi) and (epoch >= 100):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='pretrain/yolov7-tiny.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str,
                        default='cfg/training/yolov7-tiny.yaml',
                        help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='data/jmt2022.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str,
                        default='data/hyp.jmt2022.tiny.yaml',
    ...
    parser.add_argument('--name', default='yolov7-tiny',
                        help='save to project/name')
